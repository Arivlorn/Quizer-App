...
public class SwipeToDelete extends ItemTouchHelper.SimpleCallback{
    ...
    public SwipeToDelete(QuestionAdapter adapter) {

        // only support left/right swiping (not up/down)
    ...
    public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder target) {
        return false;   // question cannot be moved, only swiped left or right.
    }
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        // Tell QuestionAdapter to delete the swiped question
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder,
        ...
        */
        ...
        if (dX > 0) {
            ...
            mBackground.setBounds(itemView.getLeft(), itemView.getTop(), itemView.getLeft() + ((int) dX),
                    itemView.getBottom());
